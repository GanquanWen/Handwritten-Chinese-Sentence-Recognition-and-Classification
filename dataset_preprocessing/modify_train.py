...
os.mkdir('modify_train58')

# convert training set
for folder in os.listdir('/Users/yuchen/Desktop/Dataset/HWDB1.1/Train'):
    if len(folder) == 5:
        os.chdir('/Users/yuchen/Desktop/Dataset/HWDB1.1/modify_train58')
        os.mkdir(folder)
        # os.chdir('/Users/yuchen/Desktop/Dataset/HWDB1.1/gray_train/' + folder)
        cwd = '/Users/yuchen/Desktop/Dataset/HWDB1.1/Train/' + folder
        write_d = '/Users/yuchen/Desktop/Dataset/HWDB1.1/modify_train58/' + folder
